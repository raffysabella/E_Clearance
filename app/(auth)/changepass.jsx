...
const ResetPass = () => {
    ...
    const [newpassVisible, setPassVisible] = useState("");
        ...
        >
            ...
            <View style={[styles.outerCOn, {bottom: keyboardVisible ? SCREEN_HEIGHT * 0.35 : SCREEN_HEIGHT * 0.15, width: SCREEN_WIDTH * 0.85,}]}>
                ...
                <View style={styles.resetCon}>
                    ...
                    <TextInput style={styles.resetpassInput} value={newpass} secureTextEntry={true}></TextInput>
                    <Text style={styles.inputLabel}>Confirm Password</Text>
                    <TextInput style={styles.resetpassInput} value={confirmPass} secureTextEntry={true}></TextInput>
                </View>
                    <LinearGradient
