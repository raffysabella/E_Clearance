...
const ResetPass = () => {
    ...
    const [email, setEmail] = useState("rixjunbanawan@gmail.com");
        ...
        >
            ...
            <View style={[styles.outerCOn, {bottom: keyboardVisible ? SCREEN_HEIGHT * 0.35 : SCREEN_HEIGHT * 0.15, width: SCREEN_WIDTH * 0.85,}]}>
                ...
                <View style={styles.resetCon}>
                    <Text style={styles.inputLabel}>Email for OTP Verification</Text>
                    <TextInput style={styles.resetpassInput}></TextInput>
                    ...
                    >
                        ...
                        >
                            <Text style={styles.confirmbtntxt}>Send OTP</Text>
                        </TouchableOpacity>    
                    </LinearGradient> 
            </View>
            </SafeAreaView>
